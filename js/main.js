...
var getAnnouncementObject = function (avatar_number, title, prices, types, rooms, guests, checkin_arr, checkout_arr, features, descriptions, photos) {
  var announcement = {
    "author": {
    ...
    "offer": {
      ...
      "checkin": getRandomArrayElement(checkin_arr),
      "checkout": getRandomArrayElement(checkout_arr),
      "features": changeArrayLength(features),
      "description": getRandomArrayElement(descriptions),
      "photos": changeArrayLength(photos),
    },
    "location": {
      "x": getRandomNumber(0, 900),
